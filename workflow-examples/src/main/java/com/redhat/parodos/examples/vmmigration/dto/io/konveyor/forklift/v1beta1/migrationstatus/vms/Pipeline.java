...
public class Pipeline implements io.fabric8.kubernetes.api.model.KubernetesResource {
	...
	@com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
	private java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.migrationstatus.vms.pipeline.Tasks> tasks;

	public java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.migrationstatus.vms.pipeline.Tasks> getTasks() {
		return tasks;
	}

	public void setTasks(
			java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.migrationstatus.vms.pipeline.Tasks> tasks) {
		this.tasks = tasks;
	}
