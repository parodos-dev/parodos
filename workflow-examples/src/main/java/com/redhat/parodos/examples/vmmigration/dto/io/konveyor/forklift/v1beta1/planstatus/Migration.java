...
public class Migration implements io.fabric8.kubernetes.api.model.KubernetesResource {
	...
	@com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
	private java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.planstatus.migration.History> history;

	public java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.planstatus.migration.History> getHistory() {
		return history;
	}

	public void setHistory(
			java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.planstatus.migration.History> history) {
	...
	@com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
	private java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.planstatus.migration.Vms> vms;

	public java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.planstatus.migration.Vms> getVms() {
		return vms;
	}

	public void setVms(
			java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.planstatus.migration.Vms> vms) {
		this.vms = vms;
	}
