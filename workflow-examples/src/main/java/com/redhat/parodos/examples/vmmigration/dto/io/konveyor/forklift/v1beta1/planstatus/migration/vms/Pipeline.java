...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({ "annotations", "completed", "description", "error", "name",
		"phase", "progress", "reason", "started", "tasks" })
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(
		using = com.fasterxml.jackson.databind.JsonDeserializer.None.class)
@javax.annotation.processing.Generated("io.fabric8.java.generator.CRGeneratorRunner")
public class Pipeline implements io.fabric8.kubernetes.api.model.KubernetesResource {
	...
	@com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
	private java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.planstatus.migration.vms.pipeline.Tasks> tasks;

	public java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.planstatus.migration.vms.pipeline.Tasks> getTasks() {
		return tasks;
	}

	public void setTasks(
			java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.planstatus.migration.vms.pipeline.Tasks> tasks) {
		this.tasks = tasks;
	}
