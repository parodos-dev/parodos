...
public class Warm implements io.fabric8.kubernetes.api.model.KubernetesResource {
	...
	@com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
	private java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.migrationstatus.vms.warm.Precopies> precopies;

	public java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.migrationstatus.vms.warm.Precopies> getPrecopies() {
		return precopies;
	}

	public void setPrecopies(
			java.util.List<com.redhat.parodos.examples.vmmigration.dto.io.konveyor.forklift.v1beta1.migrationstatus.vms.warm.Precopies> precopies) {
