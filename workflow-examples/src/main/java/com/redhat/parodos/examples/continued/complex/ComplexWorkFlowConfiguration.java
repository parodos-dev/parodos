...
// .addToDetails("An example of a complex WorkFlow with Status
/// checks").displayName("Onboarding")
...
// @Infrastructure
// WorkFlow onboardingWorkflow(@Qualifier("certWorkFlowTask") LoggingWorkFlowTask
// certWorkFlowTask,
...
// @Infrastructure
// WorkFlow nameSpaceWorkFlow(@Qualifier("nameSpaceWorkFlowTask") LoggingWorkFlowTask
...
// @Infrastructure
// WorkFlow networkingWorkFlow(@Qualifier("loadBalancerFlowTask") LoggingWorkFlowTask
// networkingFlowTask,
...
// @Checker(nextWorkFlowName = "nameSpaceWorkFlow" +
...
// @Checker(nextWorkFlowName = "networkingWorkFlow" +
// WorkFlowConstants.INFRASTRUCTURE_WORKFLOW,
// cronExpression = "0 0/1 * * * ?")
// WorkFlow namespaceWorkFlowCheckerWorkFlow(
// @Qualifier("processCompletionChecker") MockApprovalWorkFlowCheckerTask
// processCompletionChecker) {
//		// @formatter:off
//		return SequentialFlow.Builder.aNewSequentialFlow()
