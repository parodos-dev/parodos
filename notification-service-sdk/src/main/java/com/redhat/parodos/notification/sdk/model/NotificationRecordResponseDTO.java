...
public class NotificationRecordResponseDTO {
  ...
  * @throws IOException if the JSON Object is invalid with respect to NotificationRecordResponseDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NotificationRecordResponseDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NotificationRecordResponseDTO is not found in the empty JSON string", NotificationRecordResponseDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!NotificationRecordResponseDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotificationRecordResponseDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if ((jsonObj.get("fromuser") != null && !jsonObj.get("fromuser").isJsonNull()) && !jsonObj.get("fromuser").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NotificationRecordResponseDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NotificationRecordResponseDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NotificationRecordResponseDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NotificationRecordResponseDTO.class));
  ...
  * @throws IOException if the JSON string is invalid with respect to NotificationRecordResponseDTO
  */
