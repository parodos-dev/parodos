...
public class PageNotificationRecordResponseDTO {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PageNotificationRecordResponseDTO
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PageNotificationRecordResponseDTO.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PageNotificationRecordResponseDTO is not found in the empty JSON string", PageNotificationRecordResponseDTO.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PageNotificationRecordResponseDTO.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageNotificationRecordResponseDTO` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PageNotificationRecordResponseDTO.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PageNotificationRecordResponseDTO' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PageNotificationRecordResponseDTO> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PageNotificationRecordResponseDTO.class));
  ...
  * @throws IOException if the JSON string is invalid with respect to PageNotificationRecordResponseDTO
  */
