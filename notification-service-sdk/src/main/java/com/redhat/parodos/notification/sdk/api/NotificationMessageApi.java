...
public class NotificationMessageApi {
     ...
     */
    public okhttp3.Call createCall(NotificationMessageCreateRequestDTO notificationMessageCreateRequestDTO, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createValidateBeforeCall(NotificationMessageCreateRequestDTO notificationMessageCreateRequestDTO, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'notificationMessageCreateRequestDTO' is set
        if (notificationMessageCreateRequestDTO == null) {
            throw new ApiException("Missing the required parameter 'notificationMessageCreateRequestDTO' when calling create(Async)");
        }
     ...
     */
    public ApiResponse<Void> createWithHttpInfo(NotificationMessageCreateRequestDTO notificationMessageCreateRequestDTO) throws ApiException {
     ...
     */
    public okhttp3.Call createAsync(NotificationMessageCreateRequestDTO notificationMessageCreateRequestDTO, final ApiCallback<Void> _callback) throws ApiException {
