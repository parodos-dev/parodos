...
import com.redhat.parodos.notification.sdk.model.ErrorMessageDTO;
...
public class NotificationRecordApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Successfully retrieved the amount of notifications </td><td>  -  </td></tr>
    ...
    private okhttp3.Call countUnreadNotificationsValidateBeforeCall(String state, final ApiCallback _callback) throws ApiException {
    ...
    /**
     * Return the number of the notification records with given state for the user (asynchronously)
     * 
     * @param state  (required)
     ...
     */
    public okhttp3.Call countUnreadNotificationsAsync(String state, final ApiCallback<Integer> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteNotificationValidateBeforeCall(UUID id, final ApiCallback _callback) throws ApiException {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successfully retrieved page of notifications </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Bad Request </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Not Found </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getNotificationsCall(Integer page, Integer size, List<String> sort, String state, String searchTerm, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNotificationsValidateBeforeCall(Integer page, Integer size, List<String> sort, String state, String searchTerm, final ApiCallback _callback) throws ApiException {
     ...
     */
    public PageNotificationRecordResponseDTO getNotifications(Integer page, Integer size, List<String> sort, String state, String searchTerm) throws ApiException {
        ApiResponse<PageNotificationRecordResponseDTO> localVarResp = getNotificationsWithHttpInfo(page, size, sort, state, searchTerm);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageNotificationRecordResponseDTO> getNotificationsWithHttpInfo(Integer page, Integer size, List<String> sort, String state, String searchTerm) throws ApiException {
        okhttp3.Call localVarCall = getNotificationsValidateBeforeCall(page, size, sort, state, searchTerm, null);
        Type localVarReturnType = new TypeToken<PageNotificationRecordResponseDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getNotificationsAsync(Integer page, Integer size, List<String> sort, String state, String searchTerm, final ApiCallback<PageNotificationRecordResponseDTO> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateNotificationStatusByIdCall(UUID id, String operation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateNotificationStatusByIdValidateBeforeCall(UUID id, String operation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
    ...
    public NotificationRecordResponseDTO updateNotificationStatusById(UUID id, String operation) throws ApiException {
        ApiResponse<NotificationRecordResponseDTO> localVarResp = updateNotificationStatusByIdWithHttpInfo(id, operation);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NotificationRecordResponseDTO> updateNotificationStatusByIdWithHttpInfo(UUID id, String operation) throws ApiException {
        okhttp3.Call localVarCall = updateNotificationStatusByIdValidateBeforeCall(id, operation, null);
        Type localVarReturnType = new TypeToken<NotificationRecordResponseDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateNotificationStatusByIdAsync(UUID id, String operation, final ApiCallback<NotificationRecordResponseDTO> _callback) throws ApiException {
