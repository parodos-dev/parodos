...
public class NotificationRecordApi {
     ...
     */
    public okhttp3.Call getNotificationsCall(Pageable pageable, String state, String searchTerm, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNotificationsValidateBeforeCall(Pageable pageable, String state, String searchTerm, final ApiCallback _callback) throws ApiException {
     ...
     */
    public PagedModelNotificationRecordResponseDTO getNotifications(Pageable pageable, String state, String searchTerm) throws ApiException {
        ApiResponse<PagedModelNotificationRecordResponseDTO> localVarResp = getNotificationsWithHttpInfo(pageable, state, searchTerm);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedModelNotificationRecordResponseDTO> getNotificationsWithHttpInfo(Pageable pageable, String state, String searchTerm) throws ApiException {
        okhttp3.Call localVarCall = getNotificationsValidateBeforeCall(pageable, state, searchTerm, null);
        Type localVarReturnType = new TypeToken<PagedModelNotificationRecordResponseDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getNotificationsAsync(Pageable pageable, String state, String searchTerm, final ApiCallback<PagedModelNotificationRecordResponseDTO> _callback) throws ApiException {
