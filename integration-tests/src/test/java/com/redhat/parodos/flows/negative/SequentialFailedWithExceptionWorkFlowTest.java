...
public class SequentialFailedWithExceptionWorkFlowTest {
	...
	public void runSequentialFailedWithExceptionWorkFlow() throws ApiException {
		...
		assertThat(workFlowStatusResponseDTO.getMessage()).isEqualTo("FailedWithExceptionWorkFlowTask failure");
		...
		assertThat(workFlowStatusResponseDTO.getWorks().get(0).getName()).isEqualTo("failedWithExceptionWorkFlowTask");
		...
		assertThat(workFlowStatusResponseDTO.getWorks().get(0).getMessage())
				.isEqualTo("FailedWithExceptionWorkFlowTask failure");
