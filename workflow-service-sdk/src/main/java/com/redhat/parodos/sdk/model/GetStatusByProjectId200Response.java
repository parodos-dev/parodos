...
public class GetStatusByProjectId200Response {
	...
	public GetStatusByProjectId200Response works(List<WorkStatusResponseDTO> works) {
	...
	public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
		...
		public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
			...
			final TypeAdapter<GetStatusByProjectId200Response> thisAdapter = gson.getDelegateAdapter(this,
					TypeToken.get(GetStatusByProjectId200Response.class));

			return (TypeAdapter<T>) new TypeAdapter<GetStatusByProjectId200Response>() {
				@Override
