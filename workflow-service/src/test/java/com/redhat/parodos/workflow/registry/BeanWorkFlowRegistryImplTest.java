...
//
// // then
// Mockito.verify(this.beanFactory,
// Mockito.times(0)).getDependenciesForBean(Mockito.any());
// Mockito.verify(this.workFlowDefinitionService, Mockito.times(0)).save(Mockito.any(),
// Mockito.any(),
...
// // when
// BeanWorkFlowRegistryImpl registry = new BeanWorkFlowRegistryImpl(this.beanFactory,
// this.workFlowDefinitionService, new HashMap<String, WorkFlowTask>(), new
...
// // then
// Mockito.verify(this.beanFactory,
// Mockito.times(1)).getDependenciesForBean(Mockito.any());
// Mockito.verify(this.workFlowDefinitionService,
// Mockito.times(1)).save(Mockito.eq("test"), Mockito.eq("test"),
...
// // then
// Mockito.verify(this.beanFactory,
// Mockito.times(2)).getDependenciesForBean(Mockito.any());
// Mockito.verify(this.workFlowDefinitionService,
// Mockito.times(1)).save(Mockito.eq("test"), Mockito.eq("test"),
// Mockito.eq(WorkFlowType.ASSESSMENT), Mockito.argThat(argument -> {
// if (argument instanceof HashMap) {
...
//
// Mockito.verify(this.workFlowDefinitionService,
// Mockito.times(1)).saveWorkFlowChecker(Mockito.eq("test-task"),
