...
//
// this.workFlowService = new WorkFlowServiceImpl(this.workFlowDelegate,
// this.workFlowDefinitionRepository,
// this.workFlowRepository, this.workFlowTaskRepository,
// workFlowWorkDependencyRepository);
// }
//
// @Test
...
// SequentialFlow workFlow =
// SequentialFlow.Builder.aNewSequentialFlow().named("test").execute(work).build();
//
...
//
// Mockito.verify(this.workFlowDelegate,
// Mockito.times(1)).getWorkFlowExecutionByName(Mockito.any());
// Mockito.verify(this.workFlowDelegate,
// Mockito.times(1)).initWorkFlowContext(Mockito.any(), Mockito.any(),
// Mockito.any());
// Mockito.verify(this.workFlowDefinitionRepository,
// Mockito.times(1)).findByName(Mockito.any());
...
// Mockito.times(1)).getWorkFlowExecutionByName(Mockito.any());
// Mockito.verify(this.workFlowDelegate,
// Mockito.times(0)).initWorkFlowContext(Mockito.any(), Mockito.any(),
// Mockito.any());
// Mockito.verify(this.workFlowDefinitionRepository,
// Mockito.times(0)).findByName(Mockito.any());
// }
//
// @Test
...
// WorkFlowExecution.builder().status(WorkFlowStatus.COMPLETED).build();
...
//
// // when
// WorkFlowExecution res = this.workFlowService.saveWorkFlow(projectId, workflowDefID,
// WorkFlowStatus.COMPLETED);
//
// // then
// assertNotNull(res);
//
// ArgumentCaptor<WorkFlowExecution> argument =
...
// assertEquals(argument.getValue().getWorkFlowDefinitionId().toString(),
// workflowDefID.toString());
// }
//
// @Test
...
//
// WorkFlowExecution workFlowExecution =
// WorkFlowExecution.builder().status(WorkFlowStatus.COMPLETED)
...
//
// WorkFlowTaskExecution workFlowTaskExecution =
// WorkFlowTaskExecution.builder().arguments("test").results("res")
...
// // when
//
// WorkFlowTaskExecution res = this.workFlowService.getWorkFlowTask(wfExecutionID,
// wfTaskDefID);
// // then
// assertNotNull(res);
...
// // when
// WorkFlowTaskExecution res = this.workFlowService.saveWorkFlowTask("arguments",
// wfTaskDefID, wfExecutionID,
// WorkFlowTaskStatus.COMPLETED);
//
// // then
// assertNotNull(res);
//
// ArgumentCaptor<WorkFlowTaskExecution> argument =
// ArgumentCaptor.forClass(WorkFlowTaskExecution.class);
// Mockito.verify(this.workFlowTaskRepository, Mockito.times(1)).save(argument.capture());
// assertEquals(argument.getValue().getStatus().toString(), "COMPLETED");
// assertEquals(argument.getValue().getWorkFlowExecutionId().toString(),
// wfExecutionID.toString());
// assertEquals(argument.getValue().getWorkFlowTaskDefinitionId().toString(),
// wfTaskDefID.toString());
