...
// this.workFlowTaskDefinitionRepository =
// Mockito.mock(WorkFlowTaskDefinitionRepository.class);
...
// this.workFlowTaskDefinitionRepository, this.workFlowRepository,
...
// Mockito.verify(this.workFlowService, Mockito.times(0)).execute(Mockito.any(),
...
// WorkFlowTaskExecution.builder().arguments("{\"test\": \"test\"}")
...
// Mockito.when(this.workFlowTaskDefinitionRepository.findById(Mockito.any())).thenReturn(Optional.of(wfTaskDef));
// WorkFlowTaskExecution workFlowTaskExecution =
// WorkFlowTaskExecution.builder().arguments("invalid")
// .results("res").status(WorkFlowTaskStatus.COMPLETED).workFlowTaskDefinitionId(wfTaskDef.getId())
// .workFlowExecutionId(wfExecution.getId()).build();
// workFlowTaskExecution.setId(UUID.randomUUID());
//
...
// WorkFlowTaskDefinition wfTaskDef =
