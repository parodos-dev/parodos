...
public class WorkFlowController {
    ...
    public ResponseEntity<WorkFlowResponseDTO> execute(@RequestBody @Valid WorkFlowRequestDTO workFlowRequestDTO) {
        Map<String, Map<String, String>> workFlowTaskArguments = getWorkflowTaskArguments(workFlowRequestDTO.getTasks());

        WorkFlow workFlow = workFlowDelegate.getWorkFlowExecutionByName(workFlowRequestDTO.getName());
        WorkReport workReport = workFlowService.execute(workFlow,
    ...
    private Map<String, Map<String, String>> getWorkflowTaskArguments(
            List<WorkFlowRequestDTO.WorkFlowTaskRequestDTO> workFlowTaskExecutionRequestDTOList) {
